...
const Checkout = () => {
  ...
  const [addiontalDriverUserIdentification, setAddiontDriverUserIdentification] = useState('')
  const [addiontalDriverDrivingLicence, setAddiontaDriverDrivingLicence] = useState('')
  ...
  const handleAddiontDriverUserIdentificationChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setAddiontDriverUserIdentification(e.target.value)
  }    
  const handleAddiontaDriverDrivingLicenceChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setAddiontaDriverDrivingLicence(e.target.value)
  }
    ...
    try {
      ...
      if (adRequired && additionalDriver && addiontalDriverBirthDate) {
        _additionalDriver = {
          ...
          userIdentification: addiontalDriverUserIdentification,
          userDrivingLicence: addiontalDriverDrivingLicence,
